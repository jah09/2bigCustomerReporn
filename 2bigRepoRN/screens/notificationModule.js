...
// import {GOOGLE_API_KEY_TIME} from "../APIKEY";
...
//               // Get the current time from the World Clock API
//               const currentTime = await getCurrentTime();
  
//               // Find the matched scheduled notification
//               const matchedScheduledNotification = formattedNotifications.find(
//                 (notification) => {
//                   if (notification.scheduledSent instanceof Date) {
//                     // Get the date parts of the scheduledSentDate and currentTime
//                     const scheduledSentDateOnly = new Date(
//                       notification.scheduledSent.getFullYear(),
//                       notification.scheduledSent.getMonth(),
//                       notification.scheduledSent.getDate()
//                     );
...
//                     return scheduledSentDateOnly.getTime() === currentTimeOnly.getTime();
//                   }
//                   return false;
//                 }
//               );
...
//         const data = await response.json();
//         const currentTime = DateTime.fromISO(data.currentDateTime, { zone: 'utc' })
//           .setZone('local')
//           .toJSDate();
//         return currentTime;
//       } else {
//         console.error('Invalid response from World Clock API:', response);
//         return new Date(); // Return the current time as a fallback
//       }
//     } catch (error) {
//       console.error('Error fetching current time:', error);
//       return new Date(); // Return the current time as a fallback
...
//           })
//           .map((notification) => {
//             console.log(notification); // Console log each sorted notification
//             return (
//                 <View
//                   key={notification.notificationID}
//                   style={[
